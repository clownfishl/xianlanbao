// pages/ucenter/userMsg/reviseMsg/reviseMsg.js
var that
var list = []
Page({
  ...
  formSubmit: function(e) {
    ...
    var area = that.data.multiArray[0][that.data.multiIndex[0]] + that.data.multiArray[1][that.data.multiIndex[1]];
    var date = that.data.date
    // 请求接口 成功之后跳转回个人资料 根据请求返回更新个人资料
  },
  /**
   * 生命周期函数--监听页面初次渲染完成
   */
