...
Page({
  ...
  selected3: function(e) {
    ...
    this.data.selectList.spec = [];
    this.data.selectList.spec.push(this.data.slot_content3);
  },
  ...
  // 重置
  reset: function() {
    for (var item in this.data.goodList) {
      this.data.goodList[item].isshow = true;
    }
    this.data.slot_show1 = false,
      this.data.slot_show2 = false,
      this.data.slot_show3 = false,
      this.data.slot_show4 = false,
      this.setData(this.data);
  }
})